...
const AstronomyModule = ({ lat, lon }) => {
  ...
  // Effect to fetch astronomical data based on selected date, time, latitude, and longitude
  useEffect(() => {
  ...
  // Object containing planet images
  const planetImages = {
  ...
  // Effect to find the most visible planet based on altitude
  useEffect(() => {
